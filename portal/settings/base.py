...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "workshop.context_processors.site_chrome",
            ],
        },
    },
]
...
# Meta Ads — Pixel on public pages; CAPI Purchase from confirm_paid.
META_PIXEL_ID = env("META_PIXEL_ID")
META_CAPI_ACCESS_TOKEN = env("META_CAPI_ACCESS_TOKEN")
META_DOMAIN_VERIFICATION = env("META_DOMAIN_VERIFICATION")
